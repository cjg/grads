...
struct gacmn {
  ...
  gaint rbcols[100];           /* User rainbow colors                   */
  gadouble cmin,cmax,cint;     /* User specified contour limits         */
  gaint cflag;                 /* If true, user specifies contour levels*/
  gadouble clevs[100];         /* User specified contour levels         */
  gaint ccflg;                 /* If true, user specifies contour colors*/
  gaint ccols[100];            /* User specified contour colors         */
  gaint shdcls[120];           /* Shade colors after shading            */
  gadouble shdlvs[120];        /* Shade levels                          */
  ...
  gaint sdfwtype;            /* type of sdf output: 1=nc, 2=hdf */
...
struct gastat {
  ...
  gaint type;                /* Result type (grid or stn)             */
...
struct gag2indx {
  ...
  gaint g2intnum;               /* Number of index g2ints */  
...
gaint garrow (gaint, gaint, gaint, gaint, gaint, gaint, gadouble *, char *);
...
struct g2buff * g2read (g2int, g2int, gaint, gaint, gaint);
void g2clear(void);
#endif
...
gaint gat2ch (struct dt *, gaint, char *);
